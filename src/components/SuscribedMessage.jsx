  ...
  return (
    <section className="w-full h-full lg:w-[430px] lg:px-8 lg:py-8 px-4 flex flex-col justify-center">
      ...
      <section className="mt-4">
        ...
        <button className="text-white text-sm w-full rounded-md p-3 mt-4 font-global font-bold bg-dark-slate-grey text-center transition-colors duration-300 ease-in hover:bg-charcoal-grey">
          Dissmiss Message
        </button>
      </section>
    </section>
